...
app.post('/home/pick_color', function(req, res) {
    ...
    .then(info => {
    	res.render('pages/home',{
				...
				color: info[0].color_hex, // Return the hex value of the color added to the table
...
// <!--
// app.post('pages/team_stats',function(req,res){
// 	var table = document.getElementById("football_games");//Retrieve our table element
